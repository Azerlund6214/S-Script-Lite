...
//alert(pressed123.join('\n'));
	...
	function check_combinations(event)
	{
		...
		// /*
			...
			var div = document.getElementById('antiplag');
			...
			if ( div == null )
			{
				...
				div.id = "antiplag";
				div.style = "position: fixed; z-index: 100; bottom: 10px; left: 30px; color: red; font-size:32px;";
				document.body.append(div);
				
				div.innerHTML = "Keys = " + arr_keys_pressed;
				return;
			}
